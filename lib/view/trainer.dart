...
class _AddTrainerFormState extends State<AddTrainerForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _formKey,
      child:provider.user!.role=="admin"?Column(
        ...
        children: <Widget>[
                ...
                child: OutlinedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      dialogUtilites.lodingDialog(context, 'Adding Trainer...');
          ...
          Center(
            child: ElevatedButton(onPressed: () {
              Navigator.pushNamed(context, '/trainerslist');
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: Colors.black,
              foregroundColor: Colors.white,
            ), child: const Text('Show Trainers'),
            ),
          ),
        ],
      ):
